...
<div id="mainPanel">
    <form action="/week" method="get">
        ...
        <input class="btn" type="submit" value="For a week">
    </form>
                ...
                <tr>
                    <td>
                        ...
                        <c:forEach var="var" items="${requestScope.listMo[i]}">
                            ...
                            <c:if test="${var.star == 1}">
                                <span class="${odd}">On the Odd week</span>
                            </c:if>
                            <c:if test="${var.star == 2}">
                                <span class="${even}">On the Even week</span>
                            </c:if>
                            <br>
                        </c:forEach>
                    </td>
