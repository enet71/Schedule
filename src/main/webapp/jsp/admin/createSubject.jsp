    ...
    <div class="form">
        <form action="/createSubject" method="post">
            <fieldset>
                ...
                Name:<br>
                <input maxlength="25" type="text" name="name" required><br><br>
        ...
        <c:forEach var="var" items="${requestScope.listSub}">
            ...
            <div id="${var.id}" class="bord">
                <form action="/editSubject" method="post">
                    ...
                    Name:<br>
                    <input maxlength="25" value="${var.name}" type="text" name="name" required><br><br>
                    <input type="submit" value="Edit">
                </form>
                <form action="/removeSubject" method="get">
